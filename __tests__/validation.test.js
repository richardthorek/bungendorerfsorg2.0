/**
 * Tests for server-side form validation. Exercises the real shared
 * implementation (api/shared/contactValidation.js) used by both
 * api/contact/index.js and server.js, so this suite fails if either backend
 * drifts from it.
 */
